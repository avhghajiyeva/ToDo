...
$route['index'] = 'listController/index';
$route['show'] = 'listController/show';
$route['create'] = 'listController/create';
$route['edit/(:num)'] = 'listController/edit/$1';
...
$route['login-page'] = 'listController/loginPage';
$route['login'] = 'listController/login';
$route['logout'] = 'listController/logout';
